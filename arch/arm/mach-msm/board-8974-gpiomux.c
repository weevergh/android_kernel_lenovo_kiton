...
static struct gpiomux_setting gpio_factory_grip_suspend_config = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_DOWN,
       .dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm8974_factory_grip_config[] __initdata = {
       {
               .gpio = 34,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &gpio_factory_grip_suspend_config,
               },
       },
};

static struct gpiomux_setting gpio_gsm_modem_download_suspend_config = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_DOWN,
       .dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm8974_gsm_modem_download_config[] __initdata = {
       {
               .gpio = 47,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &gpio_gsm_modem_download_suspend_config,
               },
       },
};

static struct gpiomux_setting gpio_in_active_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting sim_swap_dect_config = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_16MA,
       .pull = GPIOMUX_PULL_DOWN,
       .dir = GPIOMUX_OUT_LOW,
...
/*
static struct gpiomux_setting uim1_dect_config = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_16MA,
       .pull = GPIOMUX_PULL_UP,
       .dir = GPIOMUX_OUT_HIGH,
...
// liqiang11, add for SIM Smart Switch Feature.
static struct gpiomux_setting sim_switch_config = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_16MA,
       .pull = GPIOMUX_PULL_NONE,
       .dir = GPIOMUX_IN,
...
/* zengwen1, 20130521, modem ap sleep wakeup*/
#if 1
static struct gpiomux_setting modem_ready_ap = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_NONE,
       .dir = GPIOMUX_IN,
...
static struct gpiomux_setting ap_ready_modem = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_NONE,
       .dir = GPIOMUX_OUT_HIGH,
...
static struct gpiomux_setting ap_wakeup_modem = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_UP,
       .dir = GPIOMUX_OUT_HIGH,	
...
static struct gpiomux_setting modem_wakeup_ap = {
       .func = GPIOMUX_FUNC_GPIO,
       .drv = GPIOMUX_DRV_2MA,
       .pull = GPIOMUX_PULL_UP,
       .dir = GPIO_CFG_INPUT,	
...
#endif
static struct msm_gpiomux_config msm_sim_configs[] __initdata = {
       {
               .gpio = 58,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &sim_swap_dect_config,
               },
        },
// liqiang11, add for SIM Smart Switch Feature.
/*
        {
               .gpio = 100,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &uim1_dect_config,
               },
        },
*/
};
...
// liqiang11, add for SIM Smart Switch Feature.
static struct msm_gpiomux_config msm_sim_switch_configs[] __initdata = {
       {
               .gpio = 51,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &sim_switch_config,
               },
        },
};
...
/* zengwen1, 20130521, modem ap sleep wakeup*/
#if 1
static struct msm_gpiomux_config modem_ap_sw_configs[] __initdata = {
       {
               .gpio = 27,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &ap_ready_modem,
               },
       },
	{
               .gpio = 28,
               .settings = {
                       [GPIOMUX_SUSPENDED] = &modem_ready_ap,
               },
       },
       {
       	.gpio = 45,
		.settings = {
                       [GPIOMUX_SUSPENDED] = &ap_wakeup_modem,
       	},
       },
       {
       	.gpio = 46,
		.settings = {
                       [GPIOMUX_SUSPENDED] = &modem_wakeup_ap,
		},
       },
};
#endif
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
	...
	{
		.gpio      = 1,		/* SC6500 assert */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_in_active_config,
	...
	{
		.gpio      = 53,                /* BLSP2 uart for modem2 tx */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 54,		/* BLSP2 uart for modem2 rx */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 56,		/* BLSP2 uart rfr for modem2 */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
	{
		.gpio      = 55,		/* BLSP2 uart cts for modem2  */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_uart_config,
		},
	},
...
static struct gpiomux_setting es325_uart_tx_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting es325_uart_rx_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct msm_gpiomux_config msm8974_es325_uart_configs[] __initdata = { 
    {
		.gpio = 23,
		.settings = {
			[GPIOMUX_SUSPENDED] = &es325_uart_rx_act_cfg,
			[GPIOMUX_ACTIVE] = &es325_uart_rx_act_cfg,
		},
	},
	{
		.gpio = 82,
		.settings = {
			[GPIOMUX_SUSPENDED] = &es325_uart_tx_act_cfg,
			[GPIOMUX_ACTIVE] = &es325_uart_tx_act_cfg,
		},
	},
};
...
void __init msm_8974_init_gpiomux(void)
{
	...
	msm_gpiomux_install(msm8974_es325_uart_configs,
				 ARRAY_SIZE(msm8974_es325_uart_configs));
   ...
   /* zengwen1, 20130521, modem ap sleep wakeup*/
	...
	msm_gpiomux_install(msm_sim_configs, ARRAY_SIZE(msm_sim_configs));

	// liqiang11, add for SIM Smart Switch Feature.
	msm_gpiomux_install(msm_sim_switch_configs, ARRAY_SIZE(msm_sim_switch_configs));

	msm_gpiomux_install(msm8974_factory_grip_config, ARRAY_SIZE(msm8974_factory_grip_config));

   	/* zengwen1, 20130521, modem ap sleep wakeup*/
	msm_gpiomux_install(modem_ap_sw_configs, ARRAY_SIZE(modem_ap_sw_configs));

	msm_gpiomux_install(msm8974_gsm_modem_download_config, ARRAY_SIZE(msm8974_gsm_modem_download_config));
}
