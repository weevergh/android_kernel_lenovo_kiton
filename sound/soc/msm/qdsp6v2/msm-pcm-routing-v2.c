...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	SND_SOC_DAPM_AIF_OUT("INTHFP_UL_HL", "INT_HFP_BT_HOSTLESS Capture",
		0, 0, 0, 0),
	SND_SOC_DAPM_AIF_IN("INT_BT_DL_HL", "INT_BT_HOSTLESS Playback",
		0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("INT_BT_UL_HL", "INT_BT_HOSTLESS Capture",
		0, 0, 0, 0),
	...
	*/
	...
	SND_SOC_DAPM_SWITCH("SLIMBUS_UL_HL", SND_SOC_NOPM, 0, 0,
				&fm_switch_mixer_controls),
...
static const struct snd_soc_dapm_route intercon[] = {
    ...
    {"SLIMBUS_UL_HL", "Switch", "SLIMBUS_0_TX"},
    {"SLIM0_UL_HL", NULL,"SLIMBUS_UL_HL"},
	...
	{"INT_BT_SCO_RX", NULL, "INT_BT_DL_HL"},
	{"INT_BT_UL_HL", NULL, "INT_BT_SCO_TX"},
