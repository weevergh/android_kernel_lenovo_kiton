...
#define NUM_DLCI		16//64, //huangqh2
...
/*[BEGIN] huangqh2 20130725, fix spinlock issue*/
static void write_wakeup_tsk_fun(unsigned long data);
DECLARE_TASKLET(write_wakeup_tsk, write_wakeup_tsk_fun, 0);
/*[END] huangqh2 20130725, fix spinlock issue*/
...
static int gsmld_attach_gsm(struct tty_struct *tty, struct gsm_mux *gsm)
{
	...
	/*[BEGIN] huangqh2 20130725, fix spinlock issue*/
	tasklet_init(&write_wakeup_tsk, write_wakeup_tsk_fun, (unsigned long)tty);
	/*[END] huangqh2 20130725, fix spinlock issue*/
...
{
	/*[BEGIN] huangqh2 20130725, fix spinlock issue*/
	#if 0  //schedule a tasklet to do the job
	struct gsm_mux *gsm = tty->disc_data;
	unsigned long flags;
	...
	/*[BEGIN] huangqh2 20130725, fix spinlock issue*/
	tasklet_schedule(&write_wakeup_tsk);
	/*[END] huangqh2 20130725, fix spinlock issue*/
				      ...
				      struct net_device *net)
{
	...
	struct gsm_mux_net *mux_net;
         /*zengwen1, 20131016, when SC6500 suspend, don't send data*/
	if(gpio_get_value(27) == 0)
	{
		printk("don't send data when AP_RDY_MDM = %d",gpio_get_value(27));
